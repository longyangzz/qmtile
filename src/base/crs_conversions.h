...
namespace crs_conversions
{
     ...
     */
    void CTB_DLL llh2ecef( const double& lat, const double& lon, const double& h,
     ...
     * @param h Height (in meters)
     */
    void CTB_DLL ecef2llh( const double& x, const double& y, const double& z,
